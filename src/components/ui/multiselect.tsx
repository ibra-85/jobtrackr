...
interface MultipleSelectorProps {
  ...
  /** Maximum number of badges to display before showing "+X" badge */
  maxDisplayed?: number
}
        ...
        >
          <div className="flex flex-wrap gap-1">
            ...
            {remainingCount > 0 && (
              <div
                className={cn(
                  "animate-fadeIn relative inline-flex h-7 cursor-default items-center rounded-md border border-solid bg-background px-2 text-xs font-medium text-secondary-foreground transition-all hover:bg-background",
                  badgeClassName,
                )}
              >
                +{remainingCount}
